...
ICON_CONDITION_MAP: Final[dict[str, list[int]]] = {
    ATTR_CONDITION_CLEAR_NIGHT: [1100],  # 맑은 밤
    ...
    ATTR_CONDITION_SNOWY: [400],           # 눈
    ATTR_CONDITION_SNOWY_RAINY: [303],     # 눈과 비
...
SNOWYRAIN_CONDITION_MAP = {
    ...
    'rain': [ATTR_CONDITION_RAINY,ATTR_CONDITION_HAIL,ATTR_CONDITION_LIGHTNING_RAINY],
